...
INSERT INTO properties (title, description, cost_per_night, parking_spaces, number_of_bathrooms, cover_photo_url, owner_id)
...
INSERT INTO guest_reviews (message, rating, guest_id, owner_id, reservation_id)
